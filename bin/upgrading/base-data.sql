...
INSERT IGNORE INTO priv_list (des, is_public, privcode, privname, scope) VALUES ('Allows a user to delete comments or entries from other journals. Only used in rare cases.', '0', 'deletetalk', 'Delete Comments or Entries', 'general');
UPDATE priv_list SET des='Allows a user to delete comments or entries from other journals. Only used in rare cases.',is_public='0',privname='Delete Comments or Entries',scope='general' WHERE privcode='deletetalk';
